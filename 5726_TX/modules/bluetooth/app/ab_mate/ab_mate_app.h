...
#define FLAG_RECORD_CTRL           BIT(9)
#define FLAG_RECORD_DATA_UPLOAD    BIT(10)

//APP功能配置
#define AB_MATE_EQ_EN           EQ_MODE_EN              //EQ设置
#define AB_MATE_KEY_EN          1                       //按键功能设置
#define AB_MATE_VOL_EN          1                       //音量控制
#define AB_MATE_ANC_EN          0                       //ANC控制
...
#define AB_MATE_KEY_SHORT       xcfg_cb.key1_msc_ks_sel
#define AB_MATE_KEY_DOUBLE      xcfg_cb.key1_msc_kd_sel
#define AB_MATE_KEY_THREE       xcfg_cb.key1_msc_kth_sel
#define AB_MATE_KEY_LONG        xcfg_cb.key1_msc_kl_sel
