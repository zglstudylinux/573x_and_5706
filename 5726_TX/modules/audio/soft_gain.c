...
//    printf("gain_tbl_index = %d, target_gain = %d\n",soft_gain.gain_tbl_index, soft_gain.target_gain);
}
...
{
//    if(soft_gain.fade_level != soft_gain.fade_curr) {
//        if(soft_gain.fade_curr > soft_gain.fade_level) {
//            soft_gain.fade_curr--;       //步进为1
//        } else if(soft_gain.fade_curr < soft_gain.fade_level) {
//            soft_gain.fade_curr++;
//        }
//    }
//
//    if(soft_gain.fade_curr != 0) {
//        u32 gain = soft_gain_tbl_64_1[soft_gain.fade_curr];
//
...
void soft_gain_init(void)
{
    ...
    soft_gain.fade_curr = SOFT_GAIN_MAX_LEVEL;
    soft_gain.fade_level = 0;
