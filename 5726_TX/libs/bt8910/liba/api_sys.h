...
#define vusb_reset_set_us_time(nsec)               {VBRSTCON = ((nsec * 8) << 20);}                         //vusb delay us second
...
//vusb insert/pull_out filter
#define vusb_set_pout_filter()                      RTCCON11 |= BIT(6);                                     //VUSB pull out filter，VUSB拔出滤波
#define vusb_clr_pout_filter()                      RTCCON11 &= ~BIT(6);                                    //VUSB pull out filter
