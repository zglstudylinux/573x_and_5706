...
s32 cos_hw(s32 x);                      //input Q28 output Q15, 0<=x<=2, y=cos(x*pi)
int sqrt64_hw(int64_t x);

void matrix_dot_mac_hw(void* x, void* weight, void* bia, void* output, int x_type, int weight_type, int bia_type, int out_type, int scale, int bia_scale, int N, int M, int Q0, int Q1);
void matrix_dot_mul_hw(void* x, void* y, void* bia, void* output, int x_type, int y_type, int bia_type, int out_type, int bia_scale, int N, int Q0);
void matrix_dot_add_hw(void* x, void* y, void* output, int scale, int x_type, int y_type, int out_type, int y_scale, int N, int Q0);
s32 sincos_hw(s32 angle, int cos_flag);
