...
void alc_exit(void) {}
void alc_process(s32 *dfw, s32 *xfw) {}
AT(.bt_voice.alc)
...
bool sdadc_pacc_drc_calc(s16 *ptr, u32 samples, u32 pcm_mode){return false;}
#endif
...
void sco_buffer_init(void){}
void sco_buffer_exit(void){}
#endif
