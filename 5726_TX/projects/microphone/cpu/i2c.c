...
#elif (I2C_MAPPING == I2CMAP_PB7PB6)
    GPIOBDE |= BIT(7) | BIT(6);
    GPIOBDIR |= BIT(7) | BIT(6);
    GPIOBPU |= BIT(7) | BIT(6);
    GPIOBFEN |= BIT(7) | BIT(6);
    FUNCMCON2 = I2CMAP_PB7PB6;
#elif (I2C_MAPPING == I2CMAP_PE1PE0)
    GPIOEDE |= BIT(1) | BIT(0);
    GPIOEDIR |= BIT(1) | BIT(0);
    GPIOEPU |= BIT(1) | BIT(0);
    GPIOEFEN |= BIT(1) | BIT(0);
    FUNCMCON2 = I2CMAP_PE1PE0;
