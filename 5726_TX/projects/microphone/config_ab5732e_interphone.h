...
#ifndef CONFIG_AB5732E_LE_MIC_H
#define CONFIG_AB5732E_LE_MIC_H
...
#define WIRELESS_CON_RSSI_THR                   90              //设置连接范围RSSI(-dbm)，该值越小，组队范围越小(产线建议设成70左右，以防距离太远也能配)
...
#define WIRELESS_MIC_SAMPLE_RATE_SELECT         SAMPLE_RATE_48K //无线mic采样率选择
    ...
    #define WIRELESS_MIC_RETRY_NB                   4               //重传次数（暂时支持1/2）
...
//设备端私有配置
#define DEVICE_INTERPHONE_EN                    1               //双向用做对讲机
