/*****************************************************************************
 * Module    : Config
 * File      : config_ab5732E_diff_con_vers.h
 * Function  : 搭配AB5732E的无线麦配置文件
 *****************************************************************************/

#ifndef CONFIG_AB5732E_DIFF_CON_VERS_H
#define CONFIG_AB5732E_DIFF_CON_VERS_H
...
#define WIRELESS_SPK_EN                         1               //是否支持SPK音频流（下行音频）
...
#define DEVICE_DAC_OUTPUT_EN                    0               //发射端是否使能DAC输出（调试用）
...
#define WIRELESS_MIC_USER_ALG_EN                0               //用户私有算法模块使能
...
//适配器端第二路连接特性
#define ADAPTER_SECOND_CON_VERS_EN              1               //接收端是否使能第二路con_ver不同
#define ADAPTER_SECOND_CON_VERS                 2               //接收端的第二路con_ver值
#define ADAPTER_FIRST_CON_VERS                  6               //接收端的第一路con_ver值，用于计算duration
...
//用户算法
#define USER_ALG_EN                              WIRELESS_MIC_USER_ALG_EN            //用户私有算法模块使能
...
#endif // CONFIG_AB5732E_DIFF_CON_VERS_H
