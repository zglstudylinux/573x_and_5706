...
#define PHASECOMP            SFR_RW (SFR13_BASE + 0x04*4)
#define PHASECOMP1           SFR_RW (SFR13_BASE + 0x05*4)
#define SRC0VOLCON           SFR_RW (SFR13_BASE + 0x06*4)
#define SRC1VOLCON           SFR_RW (SFR13_BASE + 0x07*4)
#define DACVOLCON            SFR_RW (SFR13_BASE + 0x08*4)
#define AU0LMIXCOEF          SFR_RW (SFR13_BASE + 0x09*4)
#define AU1LMIXCOEF          SFR_RW (SFR13_BASE + 0x0b*4)
#define DACDCSTEP            SFR_RW (SFR13_BASE + 0x10*4)
#define KEYTONECON0          SFR_RW (SFR13_BASE + 0x11*4)
#define KEYTONECON1          SFR_RW (SFR13_BASE + 0x12*4)
