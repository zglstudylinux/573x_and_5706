...
{
    printf("VBAT_VALUE():%d vbat2_coef:%d vbg:%d vbg_volt:%d VBAT_CACL_VOLTAGE:%d vbat:%d\n", VBAT_VALUE(), adc_cb.vbat2_coef, adc_cb.vbg, adc_cb.vbg_volt, VBAT_CACL_VOLTAGE(), sys_cb.vbat);
}
