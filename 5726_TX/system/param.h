...
#define PARAM_ANC_AEM_THR_FIX       0xea        //4Byte，anc_aem_rt thr_buffer fix_value
#define PARAM_BONDING_NB            0x30        //1byte, 绑定设备数量
#define PARAM_BONDING_KEY           0x31        //2byte, 绑定秘钥
#define PARAM_BONDING_MODE          0x33        //1byte, 绑定模式
#define PARAM_BONDING_ADDR0         0x34        //6byte, 绑定地址0
#define PARAM_BONDING_ADDR1         0x3a        //6byte, 绑定地址1
