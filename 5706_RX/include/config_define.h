...
#define SPK_BITS_SEL            (USB_16BITS_EN)                 //支持配置16bit
#define MIC_BITS_SEL            (USB_16BITS_EN)                 //支持配置16bit
...
#define ADCCH_PB0       3               //SARADC channel 3                  WK2
#define ADCCH_PB1       4               //SARADC channel 4                  WK3
#define ADCCH_PB2       5               //SARADC channel 5
#define ADCCH_PB3       6               //SARADC channel 6
#define ADCCH_PB4       7               //SARADC channel 7
#define ADCCH_PE5       8               //SARADC channel 8
#define ADCCH_PE6       9               //SARADC channel 9                  ADS7844 ADC0
#define ADCCH_PE7       10              //SARADC channel 10
#define ADCCH_PF0       11              //SARADC channel 11
#define ADCCH_PF3       12              //SARADC channel 12
#define ADCCH_WKO       13              //SARADC channel 13                 WKO/PB5
...
#define CLKOMAP_PB2     (4 << 0)        //G4 Clock output mapping: PB2
...
* Module    : 充电仓类型选择
*****************************************************************************/
#define LPCLK_XOSC           0          //低功耗晶振
#define LPCLK_RC2M           1          //低功耗RC
...
#define UTX0MAP_PE0     (4 << 8)        //G4 uart0 tx: PE0
#define UTX0MAP_PE7     (5 << 8)        //G5 uart0 tx: PE7
...
#define URX0MAP_PE6     (5 << 12)       //G4 uart0 rx: PE6
#define URX0MAP_TX      (0xe << 12)     //G7 uart0 map to TX pin by UT0TXMAP select(1线模式)

/*****************************************************************************
 * Module    : uart1 Mapping选择列表
 *****************************************************************************/
#define UTX1MAP_G1       1              //G1 PA6-rx,PA7-tx(rx)
#define UTX1MAP_G2       2              //G2 PF0-rx,PF3-tx(rx)
#define UTX1MAP_G3       3              //G3 VUSB

/*****************************************************************************
 * Module    : uart2 Mapping选择列表
 *****************************************************************************/
#define UTX2MAP_G1       1              //G1 PA3-rx,PA4-tx(rx)
#define UTX2MAP_G2       2              //G2 PB1-rx,PB2-tx(rx)
#define UTX2MAP_G3       3              //G3 PE6-rx,PE7-tx(rx)
#define UTX2MAP_G4       4              //G4 VUSB

/*****************************************************************************
 * Module    : spi1 Mapping选择列表 (FUNCMCON1)
 *****************************************************************************/
#define SPI1MAP_G1     (1 << 4)        //G1 SPI1CLK(PB3), SPI1DI(PE0), SPI1DO(PB4)
...
#define AUXR0                       0x06        //PB1
#define AUXR1                       0x07        //PB2
#define AUXR2                       0x08        //PF3
#define AUXR3                       0x09        //PE7
#define AUXL0                       0x0a        //PB1
#define AUXL1                       0x0b        //PB2
#define AUXL2                       0x0c        //PF3
#define AUXL3                       0x0d        //PE7
...
#define ADC_NG                      0x0f        //NULL, aux_r

//MIC & ADC channel config
...
//AUX - ADC SEL
#define CH_AUXL0                    (ADC0 << 4 | AUXL0)     //AUXL           -> DACL/ADC0
#define CH_AUXL1                    (ADC0 << 4 | AUXL1)     //AUXL           -> DACL/ADC0
#define CH_AUXL2                    (ADC0 << 4 | AUXL2)     //AUXL           -> DACL/ADC0
#define CH_AUXL3                    (ADC0 << 4 | AUXL3)     //AUXL           -> DACL/ADC0
#define CH_AUXR0                    (ADC_NG << 4 | AUXR0)   //AUXR           -> DACR
#define CH_AUXR1                    (ADC_NG << 4 | AUXR1)   //AUXR           -> DACR
#define CH_AUXR2                    (ADC_NG << 4 | AUXR2)   //AUXR           -> DACR
#define CH_AUXR3                    (ADC_NG << 4 | AUXR3)   //AUXR           -> DACR
...
#define WS_CODEC_USER0          5           //index
#define WS_CODEC_USER1          6           //index
#define WS_CODEC_SBC            7           //index
#define WS_CODEC_LC3B           8           //index, lc3_1.25ms

/*****************************************************************************
 * Module    : LEDC Mapping选择列表 FUNCMCON2[27:24]
 *****************************************************************************/
#define LEDCMAP_PA7         (1 << 24)        //G1 LEDC DAT
#define LEDCMAP_PB2         (2 << 24)        //G2 LEDC DAT
#define LEDCMAP_PB4         (3 << 24)        //G3 LEDC DAT
#define LEDCMAP_PE7         (4 << 24)        //G4 LEDC DAT
#define LEDCMAP_PF0         (5 << 24)        //G5 LEDC DAT
#define LEDCMAP_PF3         (6 << 24)        //G6 LEDC DAT
...
#define I2S_MCLK_64FS       0
#define I2S_MCLK_128FS      1
#define I2S_MCLK_256FS      2
