#ifndef _VOICE_PARAM_PROC_H
#define _VOICE_PARAM_PROC_H
...
#define SOFT_GAIN_MAX_CNT_MASK    (SOFT_GAIN_MAX_CNT-1)

#endif

typedef struct {
    bool save_param_replace_en;
    bool gain_replace_en;
    bool magic_replace_en;
    bool echo_replace_en;
    u8 mic_vol_level;
    u8 echo_level;
    u8 magic_level;
    u8 mute_level;
    u8 gain_max_level;
    u32 soft_gain_tbl[10];
    s32 magic_effect_tbl[5];
    u8 echo_max_level;
} voice_param_str_t;
