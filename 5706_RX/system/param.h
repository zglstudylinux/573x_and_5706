...
#define PARAM_BONDING_ADDR          0xea        //6Byte,记录一个共同绑定的蓝牙地址

#define PARAM_BONDING_NB            0x50        //1byte, 绑定设备数量
#define PARAM_BONDING_KEY           0x51        //2byte, 绑定秘钥
#define PARAM_BONDING_MODE          0x53        //1byte, 绑定模式
#define PARAM_BONDING_ADDR0         0x54        //6byte, 绑定地址0
#define PARAM_BONDING_ADDR1         0x5a        //6byte, 绑定地址1

#define PARAM_RTC_CAL_VALID         0x61        //1BYTE
#define PARAM_RTC_CAL_ADDR          0x62        //16BYTE
