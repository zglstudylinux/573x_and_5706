...
//ADAPTER模式按键消息
AT(.rodata.port_key.adapter_key)
const u8 adapter_key_msg_tbl[KEY_TBL_MAX_NB][KEY_MSG_MAX_IDX] = {
                //单击,                 长按下,                 HOLD,               长按抬起,               双击,                   三击                四击            五击
    [KEY_1] =   {MSG_MUSIC_PLAY_PAUSE,  MSG_PWR_OFF,            MSG_PWR_HOLD,       MSG_NO,                 MSG_NO,                 MSG_NO,             MSG_NO,         MSG_NO},
    ...
    [KEY_4] =   {MSG_NO,                MSG_NO,                 MSG_NO,             MSG_NO,                 MSG_NO,                 MSG_NO,             MSG_NO,         MSG_NO},
    [KEY_5] =   {MSG_NO,                MSG_NO,                 MSG_NO,             MSG_NO,                 MSG_NO,                 MSG_NO,             MSG_NO,         MSG_NO},
    [KEY_6] =   {MSG_NO,                MSG_NO,                 MSG_NO,             MSG_NO,                 MSG_NO,                 MSG_NO,             MSG_NO,         MSG_NO},
};
...
const u8 device_key_msg_tbl[KEY_TBL_MAX_NB][KEY_MSG_MAX_IDX] = {
    ...
    [KEY_2] =   {MSG_VOL_DOWN,          MSG_NO,                 MSG_NO,             MSG_NO,                 MSG_VOL_DOWN,           MSG_NO,             MSG_NO,         MSG_NO},
    [KEY_3] =   {MSG_VOL_UP,            MSG_NO,                 MSG_NO,             MSG_NO,                 MSG_VOL_UP,             MSG_NO,             MSG_NO,         MSG_NO},
    [KEY_4] =   {MSG_CHANGE_MODE,       MSG_NO,                 MSG_NO,             MSG_CHANGE_MODE,        MSG_NO,                 MSG_NO,             MSG_NO,         MSG_NO},
    [KEY_5] =   {MSG_NO,                MSG_NO,                 MSG_NO,             MSG_NO,                 MSG_NO,                 MSG_NO,             MSG_NO,         MSG_NO},
    [KEY_6] =   {MSG_LEDC_CHANGE,       MSG_NO,                 MSG_NO,             MSG_LEDC_ON_OFF,        MSG_NO,                 MSG_NO,             MSG_NO,         MSG_NO},
};


//BT音乐模式按键消息
AT(.rodata.port_key.bt_music_key)
const u8 bt_music_key_msg_tbl[KEY_TBL_MAX_NB][KEY_MSG_MAX_IDX] = {
                //单击,                 长按下,                 HOLD,               长按抬起,               双击,                   三击                四击            五击
    [KEY_1] =   {MSG_MUSIC_PLAY_PAUSE,  MSG_SWITCH_SIRI,        MSG_PWR_HOLD,       MSG_NO,                 MSG_NO,                 MSG_CALL_REDIAL_LAST, MSG_NO,       MSG_NO},
    [KEY_2] =   {MSG_MUSIC_PREV,        MSG_MUSIC_FB_START,     MSG_NO,             MSG_MUSIC_FB_END,       MSG_VOL_DOWN,           MSG_NO,             MSG_NO,         MSG_NO},
    [KEY_3] =   {MSG_MUSIC_NEXT,        MSG_MUSIC_FF_START,     MSG_NO,             MSG_MUSIC_FF_END,       MSG_VOL_UP,             MSG_NO,             MSG_NO,         MSG_NO},
    [KEY_4] =   {MSG_CHANGE_MODE,       MSG_NO,                 MSG_NO,             MSG_CHANGE_MODE,        MSG_NO,                 MSG_NO,             MSG_NO,         MSG_NO},
    [KEY_5] =   {MSG_NO,                MSG_NO,                 MSG_NO,             MSG_NO,                 MSG_NO,                 MSG_NO,             MSG_NO,         MSG_NO},
    [KEY_6] =   {MSG_LEDC_CHANGE,       MSG_NO,                 MSG_NO,             MSG_LEDC_ON_OFF,        MSG_NO,                 MSG_NO,             MSG_NO,         MSG_NO},
};
...
//BT通话模式按键消息
AT(.rodata.port_key.bt_call_key)
const u8 bt_call_key_msg_tbl[KEY_TBL_MAX_NB][KEY_MSG_MAX_IDX] = {
    ...
    [KEY_2] =   {MSG_NO,                MSG_NO,                 MSG_NO,             MSG_NO,                 MSG_VOL_DOWN,           MSG_NO,             MSG_NO,         MSG_NO},
    [KEY_3] =   {MSG_NO,                MSG_NO,                 MSG_NO,             MSG_NO,                 MSG_VOL_UP,             MSG_NO,             MSG_NO,         MSG_NO},
    [KEY_4] =   {MSG_NO,                MSG_NO,                 MSG_NO,             MSG_NO,                 MSG_NO,                 MSG_NO,             MSG_NO,         MSG_NO},
    [KEY_5] =   {MSG_NO,                MSG_NO,                 MSG_NO,             MSG_NO,                 MSG_NO,                 MSG_NO,             MSG_NO,         MSG_NO},
    [KEY_6] =   {MSG_LEDC_CHANGE,       MSG_NO,                 MSG_NO,             MSG_LEDC_ON_OFF,        MSG_NO,                 MSG_NO,             MSG_NO,         MSG_NO},
};
...
#else
    [KEY_1] =   {MSG_MUSIC_PLAY_PAUSE,  MSG_NO,                 MSG_PWR_HOLD,       MSG_NO,                 MSG_VOL_MUTE,           MSG_NO,             MSG_NO,         MSG_NO},
#endif
...
///PWRKEY键蓝牙休眠唤醒机制，仅KEY1~KEY3可唤醒，串接大阻值电阻的按键，不能唤醒
AT(.com_text.pwrkey.table)
const adkey_tbl_t pwrkey_table[6] = {
#if FPGA_EN
    {0x08, KEY_MULTI(KEY_1)},           //KEY1
    {0x28, KEY_MULTI(KEY_2)},           //KEY2
    {0x3A, KEY_MULTI(KEY_3)},           //KEY3
    {0x60, KEY_MULTI(KEY_4)},           //KEY4
    {0x83, KEY_NULL},                   //KEY5
    {0xFF, KEY_NULL},
#elif 1
	#if 1
    //PCB.18-002 开发板
    //pu:82K   //无按键按下时电压: 2.345V   //adcmax: 186  (VDDIO 3.3V左右)
    //pds(5): 0K 12K 47K 150K 820K
    //pu = 0.000K    V = 0.000V   adc = 0x0 =  000.0   cmp = 0x0B
    //pu = 12.000K   V = 0.299V   adc = 0x17 = 023.7   cmp = 0x2D
    //pu = 47.000K   V = 0.854V   adc = 0x43 = 067.8   cmp = 0x5E
    //pu = 150.000K  V = 1.516V   adc = 0x78 = 120.3   cmp = 0x90
    //pu = 820.000K  V = 2.123V   adc = 0xA9 = 169.1   cmp = 0xB1
    {0x0B, KEY_MULTI(KEY_1)},           //KEY1
    {0x2D, KEY_MULTI(KEY_2)},           //KEY2
    {0x5E, KEY_MULTI(KEY_3)},           //KEY3
    {0x90, KEY_MULTI(KEY_4)},           //KEY4
    {0xB1, KEY_NULL},                   //KEY5
    {0xFF, KEY_NULL},
	#else                               //配置K12样机按键
    {0x08, KEY_MULTI(KEY_1)},           //KEY1  0
    {0x28, KEY_MULTI(KEY_5)},           //KEY5  180k
    {0x50, KEY_MULTI(KEY_6)},           //KEY6  470k
    {0x78, KEY_MULTI(KEY_2)},           //KEY2  18k
    {0x95, KEY_MULTI(KEY_3)},           //KEY3  43k
    {0xB0, KEY_MULTI(KEY_4)},           //KEY4  91k
    {0xC0, KEY_NULL},
    {0xFF, KEY_NULL},
	#endif
#else
