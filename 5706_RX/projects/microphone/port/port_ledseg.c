...
#define LEDSEG_ALL_DIRIN() {GPIOADE |=0x78; GPIOADIR |= 0x78; GPIOBDE |=0x7; GPIOBDIR |= 0x7;}
#define LEDSEG_HDRV_EN()   {GPIOADE |=0x78; GPIOADRV |= 0x78; GPIOBDE |=0x7; GPIOBDRV |= 0x7;}
#define LEDSEG_HDRV_DIS()  {GPIOADRV &= ~0x78; GPIOBDRV &= ~0x7;}
